...
echo "semantic_lastRelease_version=$1" >> $GITHUB_OUTPUT
echo "semantic_lastRelease_channel=$2" >> $GITHUB_OUTPUT
echo "semantic_lastRelease_gitHead=$3" >> $GITHUB_OUTPUT
echo "semantic_lastRelease_gitTag=$4" >> $GITHUB_OUTPUT
