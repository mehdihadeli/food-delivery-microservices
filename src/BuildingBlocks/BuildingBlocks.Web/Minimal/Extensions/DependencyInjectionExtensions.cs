...
public static class DependencyInjectionExtensions
{
    ...
    )
    {
        ...
        // we also load assemblies that have some endpoints and known as a application part, because assemblies are lazy and maybe at the time of scanning, assmblies contain endpoints not visited yet.
        var assemblies =
