...
namespace ECommerce.Services.Customers.Shared.Data.Migrations.Customers
{
    ...
    public partial class InitialCustomersMigration : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        addressdetail = table.Column<string>(
                            name: "address_detail",
                            type: "character varying(50)",
                            maxLength: 50,
                            nullable: true
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        productinformationname = table.Column<string>(
                            name: "product_information_name",
                            type: "text",
                            nullable: false
                        ),
                        productinformationid = table.Column<long>(
                            name: "product_information_id",
                            type: "bigint",
                            nullable: true
                        ),
                        processed = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                        processedtime = table.Column<DateTime>(
                            name: "processed_time",
                            type: "timestamp with time zone",
                            nullable: true
                        ),
        ...
        {
            migrationBuilder.DropTable(name: "restock_subscriptions", schema: "customer");
