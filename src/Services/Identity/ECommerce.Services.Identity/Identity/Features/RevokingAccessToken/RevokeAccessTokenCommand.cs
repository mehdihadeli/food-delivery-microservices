...
public record RevokeAccessTokenCommand(string Token, string UserName) : ICommand;

public class RevokeAccessTokenCommandHandler : ICommandHandler<RevokeAccessTokenCommand>
{
    private readonly ICacheManager _cacheManager;
    private readonly JwtOptions _jwtOptions;

    public RevokeAccessTokenCommandHandler(ICacheManager cacheManager, IOptions<JwtOptions> jwtOptions)
    {
