...
[assembly: SuppressMessage(
    ...
    Scope = "member",
    Target = "~P:FoodDelivery.Services.Identity.Api.TestUsers.Users"
)]
[assembly: SuppressMessage(
    "Design",
    ...
    Scope = "type",
    Target = "~T:FoodDelivery.Services.Identity.Api.Pages.Login.ViewModel.ExternalProvider"
)]
[assembly: SuppressMessage(
    "Naming",
    ...
    Scope = "namespace",
    Target = "~N:FoodDelivery.Services.Identity.Api.Pages.Error"
)]
[assembly: SuppressMessage(
    "Naming",
    ...
    Scope = "type",
    Target = "~T:FoodDelivery.Services.Identity.Api.Pages.Ciba.Consent"
)]
[assembly: SuppressMessage(
    "Naming",
    "CA1724:Type names should not match namespaces",
    Justification = "Namespaces of pages are not likely to be used elsewhere, so there is little chance of confusion",
    Scope = "type",
    Target = "~T:FoodDelivery.Services.Identity.Api.Pages.Extensions"
)]
[assembly: SuppressMessage(
    "Performance",
    ...
    Scope = "member",
    Target = "~F:FoodDelivery.Services.Identity.Api.Pages.Logout.LogoutOptions.AutomaticRedirectAfterSignOut"
)]
