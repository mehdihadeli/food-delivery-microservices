namespace FoodDelivery.Services.Identity.Api.Pages;
...
internal static class Log
{
    ...
    private static Action<ILogger, IEnumerable<string>, Exception?> _externalClaims = LoggerMessage.Define<
        IEnumerable<string>
    >(LogLevel.Debug, EventIds.ExternalClaims, "External claims: {Claims}");
