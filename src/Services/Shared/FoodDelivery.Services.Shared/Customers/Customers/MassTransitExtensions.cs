...
namespace FoodDelivery.Services.Shared.Customers.Customers;
...
public static class MassTransitExtensions
{
    public static void ConfigureCustomerPublishMessagesTopology(this IRabbitMqBusFactoryConfigurator cfg)
    {
        ...
        cfg.SetQueueArgument("x-dead-letter-exchange", $"{nameof(CustomerCreatedV1).Underscore()}_dead_letter_exchange");
