...
using Serilog;
using Store.Services.Orders.Customers;
using Store.Services.Orders.Shared.Extensions.ApplicationBuilderExtensions;
using Store.Services.Orders.Shared.Extensions.ServiceCollectionExtensions;
