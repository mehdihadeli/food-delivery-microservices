...
public class DependencyTests
{
    ...
    {
        var factory = new CustomWebApplicationFactory<CustomersApiMetadata>()
            ...
            .AddOverrideEnvKeyValues(keyValues =>
            {
                keyValues.Add(
                    ...
                    "Server=localhost;Port=5432;Database=customers;User Id=postgres;Password=postgres;Include Error Detail=true"
                );
                keyValues.Add(
                ...
                keyValues.Add(
                    ...
                    "mongodb://admin:admin@localhost:27017/customers?authSource=admin&authMechanism=SCRAM-SHA-256"
                );
                keyValues.Add(
